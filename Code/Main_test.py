...
OPTIONS = {
        ...
        'weight_decay': 0.07, # 0.002 Res_Cifar: 0.002, Alex_Cifar: 0.008, Alex_brain: 0.03, Res_brain: 0.01, ViT: 0.07
        'momentum': 0.45, # Res_Cifar: 0.15, Alex_Cifar: 0.9, Alex_brain: 0.69, Res_brain: 0.9, ViT: 0.45
        'opt': 'sgd',
        'curriculum': False,
        'report_logs': False,
        'should_tune': False,
